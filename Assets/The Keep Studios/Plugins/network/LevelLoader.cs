...
namespace TheKeepStudios.network{
	...
	public class LevelLoader : MonoBehaviour{
		...
		private const int defaultNetworkDataGroup = 0;
		private const int gameLevelNetworkDataGroup = 1;
		public int disconnectedLevel = -1;
		private int lastLevelPrefix = 0;

		public string[] networkLoadableLevels;

		static public int DefaultNetworkDataGroup{
			get{
				return defaultNetworkDataGroup;
			}
		}

		static public int GameLevelNetworkDataGroup{
			get{
				return gameLevelNetworkDataGroup;
			}
		}
